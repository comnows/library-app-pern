...
function BookList({ onEdit }: BookListProps) {
        ...
        <table className="w-full rounded-t-xl overflow-hidden">
          <thead className="bg-green-500">
            <tr className="text-white text-left">
              ...
              <th className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">
                Classes name
              </th>
              <th className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">Year</th>
              <th className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">Writer</th>
              <th className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">Publisher</th>
            ...
            {data?.map((book) => {
              return (
                <tr key={book.id} className="border-b hover:bg-black/5">
                  ...
                  <td className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">{`${book.class_name}`}</td>
                  <td className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">
                    {book.year}
                  </td>
                  <td className="py-2 lg:py-3 px-2 md:px-3 lg:px-5">
